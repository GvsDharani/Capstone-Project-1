...
public class ProductSearchAddToCartObjects extends Browser
{
	...
	// List of WebElements representing product items displayed in the search results
	@FindBy(xpath = "//div[@class='product details product-item-details' ]/strong/a")
	public List<WebElement> productsItem;
	 // WebElement for the "Next" button in pagination to navigate to the next page of products
